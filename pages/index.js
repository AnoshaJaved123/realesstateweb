...
export default function Home() {
  ...
  return (
    <div className=''>
      ...
      <div className='px-0 h-screen w-full object-fill' style={{
        backgroundSize: "100% 100%", backgroundImage: `url(${'/h13.jpg'})`, boxShadow: '0.75'
      }}>
        <div className="text-black body-font">
          <div className=" px-5 py-16 mx-auto ">
            <div className="flex flex-col text-center lg:my-40">
              <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-6 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 ">
                <div className="relative flex-grow ">
                  <label htmlFor="name" className="leading-7 text-base font-semibold text-white  mr-6">Select Category</label>
                  <select value={category} onChange={e => setcategory(e.target.value) } type="text" name="category" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                    <option value={'Rent'} >Rent</option>
                    <option value={'Sale'} >Sale</option>
                  </select>
                </div>
                <div className="relative flex-grow ">
                  <label htmlFor="name" className="leading-7 text-base font-semibold text-white  mr-6">Select Property Type</label>
                  <select value={type} onChange={e => setType(e.target.value) } type="text" name="type" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                ...
                <div className="relative flex-grow ">
                  <div>
                    <label htmlFor="name" className="leading-7 text-base font-semibold text-white  mr-6">Select Subtype</label>
                    {type === 'Homes' && <> <select value={type} onChange={e => setSubtype(e.target.value) }  type="text" name="subtype" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                    ...
                    {type === 'Plots' && <> <select value={type} onChange={e => setSubtype(e.target.value) }  type="text" name="subtype" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                    ...
                    {type === 'Commercial' && <> <select value={type} onChange={e => setSubtype(e.target.value) }  type="text" name="subtype" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                ...
                <div className="relative flex-grow">
                  <label htmlFor="name" className="leading-7 text-base font-semibold text-white  mr-6">Select City</label>
                  <select value={city} onChange={e => setCity(e.target.value) } type="text" name="city" className="rounded border appearance-none border-gray-300 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-500 text-black pl-3 pr-10 w-full">
                ...
                <div className='items-center'>
                  ...
                  >
                  <a> <button className="text-white mt-6 bg-teal-500 border-0 py-1 px-8 focus:outline-none hover:bg-teal-400  text-lg">Find</button></a></Link>
                </div>
                ...
                <div className="flex flex-wrap -mx-4">
                  ...
                  <div className="relative md:w-1/2 px-4 mb-8 md:mb-6">
                    <div className="absolute inset-0 z-10 bg-white text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-50 duration-300">
                      ...
                      <Link href={'/rent'}><a> <button className="text-white mt-6 bg-teal-500 border-0 py-1 px-8 focus:outline-none hover:bg-teal-00  text-lg">Find</button></a></Link>
                    </div>
                  ...
                  <div className="relative md:w-1/2 px-4 mb-8 md:mb-6">
                    <div className="absolute inset-0 z-10 bg-white text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-50 duration-300">
                      ...
                      <Link href={'/buy'}><a> <button className="text-white mt-6 bg-teal-500 border-0 py-1 px-8 focus:outline-none hover:bg-teal-00  text-lg">Find</button></a></Link>
                    </div>
                    <div className="relative">
                      <div className=" flex flex-wrap content-center">
                  ...
                  <div className="relative md:w-1/2 px-4 mb-8 md:mb-0">
                    <div className="absolute inset-0 z-10 bg-white text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-50 duration-300">
                      ...
                      <Link href={'/services'}><a> <button className="text-white mt-6 bg-teal-500 border-0 py-1 px-8 focus:outline-none hover:bg-teal-00  text-lg">Find</button></a></Link>
                    </div>
                    <div className="relative">
                      <div className=" flex flex-wrap content-center">
                  ...
                  <div className="relative md:w-1/2 px-4 mb-8 md:mb-0">
                    <div className="absolute inset-0 z-10 bg-white text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-50 duration-300">
                      ...
                      <Link href={'/agents'}><a> <button className="text-white mt-6 bg-teal-500 border-0 py-1 px-8 focus:outline-none hover:bg-teal-00  text-lg">Find</button></a></Link>
                    </div>
                    <div className="relative">
                      <div className=" flex flex-wrap content-center">
          ...
          <div className="flex flex-wrap -m-2 text-center">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-teal-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
      ...
      <section className="text-black body-font">
        <div className="container px-5 py-14 mx-auto">
          <h1 className="text-center sm:text-3xl text-3xl font-medium title-font mb-6 text-teal-500">TESTIMONIALS</h1>
