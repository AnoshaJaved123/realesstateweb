    ...
    <div>
      <div className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          {!agents.data && <>
            <h2 className='text-center'>No Agents Available</h2>
          </>}
          <div  className="flex flex-wrap -m-2">     
          {agents.map((a)=>{return(<div key={a._id} className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-teal-200 border p-4 rounded-lg">
                <Image width={50} height={50} alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src={a.img}/>
...
export const getServerSideProps = async (context) => {
  ...
  let res = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/getAgents`)
