...
const Services = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-200 p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-stone-100 text-stone-700 mb-4">
    ...
    <button className="flex mx-auto mt-16 text-white bg-stone-700 border-0 py-2 px-8 focus:outline-none hover:bg-stone-600 rounded text-lg">Button</button>
  </div>
</section>
